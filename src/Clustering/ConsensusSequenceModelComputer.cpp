...
ConsensusSequenceModelComputer::ConsensusSequenceModelComputer(Matrix3D<double>&& data,
      ...
      threads(nullptr)
{
    ...
    this->data_layer = new ConsensusSequenceLayer(std::move(data),
                                                  n_class,
                                                  n_shift,
                                                  flip,
                                                  bckg_class) ;
...
ConsensusSequenceModelComputer::~ConsensusSequenceModelComputer()
{   // threads
