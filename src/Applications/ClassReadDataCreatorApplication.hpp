#ifndef CLASSREADDATACREATORAPPLICATION_HPP
#define CLASSREADDATACREATORAPPLICATION_HPP
...
/*!
 * \brief The ClassReadDataCreatorApplication is a wrapper
 * around a ClassReadDataCreator that creates a read density
 ...
 * the <binsiz> value.
 */
class ClassReadDataCreatorApplication : public ApplicationInterface
{
    public:
        ClassReadDataCreatorApplication() = delete ;
        ClassReadDataCreatorApplication(
                const ClassReadDataCreatorApplication& app) = delete ;
        /*!
         ...
         * main() function.
         */
        ClassReadDataCreatorApplication(int argn, char** argv) ;
    ...
    private:
        ...
        int to ;
        /*!
         * \brief the size of the bin that was used for
         * the original matrix.
         */
        int bin_size ;
        /*!
...
#endif // CLASSREADDATACREATORAPPLICATION_HPP
